...
pub mod pokeapi {
    ...
    impl Mocks {
        pub async fn start() -> Self {
            ...
            Mock::given(path_regex(r"/squirtle$"))
                .respond_with(ResponseTemplate::new(200).set_body_json(json!({
                    "flavor_text_entries": [{
                        "flavor_text": "this will fire a rate-limit error from the translation API",
                        "language": {
                            "name": "en"
                        }
                    }]
        ...
        pub async fn start() -> Self {
            ...
            Mock::given(body_string_contains("text=you"))
                .respond_with(ResponseTemplate::new(200).set_body_json(json!({
                    ...
                    "contents": {
                        "translated": "Thee wilt translate me",
                        "text": "you will translate me",
                ...
                .respond_with(
                    ResponseTemplate::new(200)
                        .set_body_json(json!({
                            ...
                            "contents": {
                              "translated": "At which hour several of\\nthese pokémon\\ngather,  their\\nelectricity couldst\\nbuild and cause\\nlightning storms.",
                              "text": "When BURMY evolved, its cloak\\nbecame a part of this Pokémon’s\\nbody. The cloak is never shed.",
                              "translation": "shakespeare"
                            }
                          })))
                .mount(&server)
